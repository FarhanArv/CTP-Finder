    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <?php
          $id = $_GET["id"];
          $sql = "SELECT * FROM tbl_mesin_cuci WHERE id_mesin_cuci=$id";
          ...
          ?>
            ...
            <p></p>
            <form method="post" action="../../../../backend/proses_edit_mesin.php">
              <input type="hidden" name="id_mesin_cuci" value="<?php echo $row["id_mesin_cuci"] ?>">
              <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">No</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nomor" value="<?php echo $row['id_mesin_cuci']; ?>" disabled>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_mesin" value="<?php echo $row['nama']; ?>" disabled>
                </div>
              </div>
