...
$iduser = $_SESSION['id'];
$jenis = 'Dry It Yourself';

$sql = "SELECT COUNT(*) AS jumlah_aktif FROM tbl_mesin_pengering WHERE status_mesin = 'Aktif'";
...
if (empty($jam)) {
   die("<SCRIPT LANGAUAGE='JavaScript'>
         window.location.href='../dashboard/pages/content/reservasi/form-ss-dry.php';
                  ...
                  <script type='text/javascript'>
                     document.addEventListener('DOMContentLoaded', () => {
                        Swal.fire({
                              ...
                              window.location.href = '../dashboard/pages/content/nota/nota-ss-dry.php';
                        });
                     });
                  </script>
                ");
