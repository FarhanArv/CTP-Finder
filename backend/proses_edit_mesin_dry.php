...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_mesin_pengering = $_POST["id_mesin_pengering"];
    // $iduser = $_SESSION['id'];
    ...
    if ($db_connect->connect_error) {
     ...
     if (!empty($id_mesin_pengering)) {
        $sql = "UPDATE tbl_mesin_pengering SET status_mesin='$status_mesin', kondisi='$kondisi' , id_mesin_pengering='$id_mesin_pengering' WHERE id_mesin_pengering='$id_mesin_pengering'";
