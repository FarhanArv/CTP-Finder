...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jan 2024 pada 19.36
...
--
ALTER TABLE `tbl_reservasi`
  MODIFY `id_tbl_r` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `tbl_reservasi`
  ADD CONSTRAINT `tbl_reservasi_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tbl_users` (`id_user`);
