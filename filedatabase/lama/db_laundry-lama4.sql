...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Jan 2024 pada 16.50
...
INSERT INTO `tbl_reservasi` (`id_tbl_r`, `jam`, `id_user`, `jenis_layanan`, `nomor_antrian`, `tanggal_pesanan`) VALUES
(102, '17:40', '10', 'Dry It Yourself', 3, '2024-01-03 11:40:24'),
(103, '08.20', '5', 'Dry It Yourself', 1, '2024-01-03 11:40:38'),
(104, '17:40', '10', 'Dry It Yourself', 4, '2024-01-03 14:18:59'),
(105, '20:20', '10', 'Dry It Yourself', 1, '2024-01-03 14:41:39');
...
CREATE TABLE `tbl_reservasi_do` (
  ...
  `jenis_pelayanan` varchar(45) NOT NULL,
...
INSERT INTO `tbl_users` (`id_user`, `name`, `email`, `role`, `password`, `created_at`, `update_at`, `alamat`) VALUES
...
--
ALTER TABLE `tbl_reservasi`
  MODIFY `id_tbl_r` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
