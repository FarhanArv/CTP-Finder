      ...
      <div class="col-lg-10">
        <div class="card">
          <div class="card-body">
            ...
            <p>Pastikan Jenis Layanan sudah sesuai dengan berat pakaian anda, jika terdapat kelebihan berat maka akan diinformasikan biaya tambahan melalui WhatsApp</p>
            <!-- Form Reservasi -->
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Jenis Layanan</label>
                <input class="form-control" type="text" placeholder="Dry It Yourself" aria-label="Disabled input example" disabled>
              </div>
             
              <br>  
              <h4>Self Service</h4>
                  <form action="../../../../backend/proses_reservasi-dry.php" method="post">
