      ...
      <section class="section dashboard">
        <div class="row align-items-top">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      ...
                      <?php 
                        $iduser = $_SESSION['id'];
                        $sql = mysqli_query($db_connect, "SELECT * FROM `tbl_reservasi_ss` WHERE id_user = '$iduser' AND jenis_layanan = 'Wash It Yourself' ORDER BY id_tbl_r DESC LIMIT 1");
                    ...
                    <div class="col-lg-12 text-center">
                      <a class="btn btn-primary" href="../reservasi/form-ss-wash.php" role="button">Kembali</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- <div class="col-lg-4"> 
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Catatan Khusus</h5>
